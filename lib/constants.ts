...
export const SERVICES = [
  ...
  },
  {
    ...
    shortDescription: "Gutter cleaning near me Orange County with seasonal maintenance",
    description: "Professional gutter cleaning Orange County services for residential gutter cleaning Orange County and commercial gutter cleaning Orange County. Our gutter cleaning near me Orange County team provides same day gutter cleaning Orange County, seasonal gutter cleaning Orange County, clogged gutter cleaning Orange County, and downspout cleaning Orange County. We specialize in leaf removal gutter cleaning Orange County, gutter inspection and cleaning Orange County, roof and gutter cleaning Orange County, and emergency gutter cleaning Orange County throughout Orange County, Los Angeles, and San Diego.",
    features: ["Gutter cleaning near me Orange County", "Same day gutter cleaning Orange County", "Residential gutter cleaning Orange County", "Commercial gutter cleaning Orange County", "Seasonal gutter cleaning Orange County", "Free quote gutter cleaning Orange County"],
    priceRange: "$150-$400",
    duration: "1-3 hours",
  ...
  },
  {
    ...
    shortDescription: "Commercial cleaning near me Orange County with B2B contracts",
    description: "Professional commercial cleaning Orange County services for office cleaning services Orange County and business cleaning services Orange County. Our commercial cleaning near me Orange County team provides recurring commercial cleaning Orange County, commercial janitorial services Orange County, medical office cleaning Orange County, and restaurant cleaning services Orange County. We specialize in commercial cleaning contracts Orange County, after hours commercial cleaning Orange County, industrial cleaning Orange County, and day porter services Orange County throughout Orange County, Los Angeles, and San Diego.",
    features: ["Commercial cleaning near me Orange County", "Office cleaning services Orange County", "Commercial cleaning contracts Orange County", "Medical office cleaning Orange County", "Restaurant cleaning services Orange County", "Commercial cleaning estimate Orange County"],
