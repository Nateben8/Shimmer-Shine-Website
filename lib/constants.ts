...
export const SERVICES = [
  {
    ...
    description: "Experience the difference of truly professional window cleaning that goes beyond just the glass. Our comprehensive service includes cleaning windows, frames, tracks, and screens to ensure every detail sparkles. As licensed and insured professionals, we bring years of expertise to both residential and commercial properties throughout Southern California. Using eco-friendly solutions and professional-grade equipment, we deliver streak-free, crystal-clear results that last. Whether you need a one-time deep clean or regular maintenance, we offer flexible scheduling with same-day availability and always provide free estimates. Trust our experienced team to make your property shine.",
