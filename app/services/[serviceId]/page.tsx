...
export async function generateMetadata({ params }: ServicePageProps) {
  ...
  return getServiceSEO(resolvedParams.serviceId)
}
              ...
              <div className="polaroid-frame">
                <div className="relative h-96 rounded-lg overflow-hidden">
                  {service.id === 'window-cleaning' ? (
                    ...
                    <Image
                      src="/natePressurewashing.jpg"
                      alt="Professional pressure washing service - Nate from Shimmer Shine Property Detailing performing pressure washing"
                      title="Expert Pressure Washing Orange County - Professional Equipment & Results"
                      fill
