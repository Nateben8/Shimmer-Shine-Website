              ...
              <div className="relative hover-lift-subtle w-full">
                <div className="w-full h-96 overflow-hidden rounded-xl shadow-2xl">
                  <Image
                    ...
                    alt="Nate and Aiden from Shimmer Shine Property Detailing - Professional window cleaning and pressure washing team serving Los Angeles County with 5-star rated service"
                    width={1200}
                    height={100}
