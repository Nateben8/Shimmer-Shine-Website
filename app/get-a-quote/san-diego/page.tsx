...
export const metadata = {
  title: "Free Window Cleaning Quote San Diego County | Shimmer Shine Property Detailing",
  description: "Get a free quote for professional window cleaning, pressure washing, and property detailing services in San Diego County. Same day service available with 15% discount for new customers.",
  keywords: "window cleaning San Diego, pressure washing San Diego County, free quote San Diego, property cleaning services SD",
  openGraph: {
    title: "Free Window Cleaning Quote San Diego County | Shimmer Shine",
    description: "Professional window cleaning and pressure washing services throughout San Diego County. Get your free quote today!",
    url: "https://www.shimmershinepropertydetailing.com/get-a-quote/san-diego",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "San Diego Window Cleaning Services",
      },
    ],
    locale: "en_US",
    type: "website",
...
export default function SanDiegoQuotePage() {
  const localBusinessSchema = getLocalBusinessSchema()
  const featuredTestimonials = TESTIMONIALS.slice(0, 3)
  
  // Enhanced Service Schema for San Diego County
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Free Window Cleaning Quote San Diego County",
    "description": "Get a free quote for professional window cleaning, pressure washing, and property detailing services in San Diego County. Same day service available with 15% discount for new customers.",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "serviceType": [
      ...
      "Pressure Washing San Diego County", 
      "Solar Panel Cleaning San Diego",
      "Gutter Cleaning San Diego",
      "Post Construction Cleanup San Diego"
    ]
  }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollAnimation animation="fade-in-left" className="text-center lg:text-left">
              ...
              <h1 className="heading-decorative text-4xl md:text-6xl text-yellow mb-2 leading-tight" style={{textShadow: '2px 2px 0px #000000, 3px 3px 0px #333333, 4px 4px 0px #666666'}}>
                Free San Diego County Cleaning Quote
              </h1>
              ...
              <p className="body-text text-xl text-gray-100 mb-6 leading-relaxed">
                Professional window cleaning, pressure washing, and property detailing throughout San Diego County. Family-owned since {BUSINESS_INFO.foundedYear} with 5-star rated service.
              </p>
            ...
            <ScrollAnimation animation="fade-in-right" delay={200} className="w-full">
              <div className="relative hover-lift-subtle">
                <Image
                  ...
                  alt="Professional window cleaning service in San Diego County - Shimmer Shine Property Detailing team providing residential and commercial window cleaning with guaranteed results"
                  width={600}
                  height={400}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="heading-primary text-3xl md:text-4xl mb-4" style={{textShadow: '1px 1px 0px #FFC107, 2px 2px 0px #FFD54F'}}>
                ...
                <span className="block sm:inline">Free San Diego Quote Below</span>
              </h2>
              <p className="body-text text-gray-600 text-lg max-w-2xl mx-auto mb-6">
                Join 500+ satisfied San Diego County customers who trust us with their property cleaning needs. Professional results guaranteed!
              </p>
            </div>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                      <p className="text-xs text-center text-navy font-medium">
                        Free on-site estimates throughout San Diego County
                      </p>
                    </div>
                  </CardContent>
                </Card>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-3xl mx-auto">
            <h3 className="heading-decorative text-4xl md:text-5xl text-navy mb-4" style={{textShadow: '2px 2px 0px #FFFFFF, 3px 3px 0px #F5F5F5, 4px 4px 0px #E0E0E0'}}>
              ...
              <span className="block sm:inline">Started in San Diego?</span>
            </h3>
            <p className="body-text text-xl text-navy-700 mb-6">
              Join 500+ satisfied San Diego County customers who've already saved with our exclusive discount. Get your FREE quote + <span className="font-bold" style={{color: '#FF4500'}}>15% OFF</span> before this offer expires!
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <GetQuoteButton 
                ...
                redirectPath="/get-a-quote/san-diego"
              >
